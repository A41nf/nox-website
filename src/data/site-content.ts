...
export const faqItems: FaqItem[] = [
  {
    question: "هل NOX مناسب للمبتدئين أم فقط لمن لديهم خبرة تدريبية؟",
    answer:
      "المكان مناسب للمبتدئ وللعميل المتقدم. نبدأ دائماً بتقييم واضح للحركة، اللياقة، والهدف الحالي ثم نبني الخطة على مستواك الفعلي لا على افتراضات عامة.",
  },
  {
    question: "هل يوجد تدريب شخصي للنساء في مسقط داخل NOX؟",
    answer:
      "نعم، لدينا برامج تدريب شخصي مخصصة للنساء مع مراعاة الخصوصية، جودة الإشراف، وتصميم خطة تناسب الهدف سواء كان خسارة الدهون أو تحسين القوة أو رفع اللياقة العامة.",
  },
  {
    question: "كم جلسة أحتاج أسبوعياً حتى أبدأ بملاحظة النتيجة؟",
    answer:
      "معظم العملاء يبدأون من 3 إلى 5 جلسات أسبوعياً بحسب الهدف والوقت المتاح. النتيجة لا تعتمد على عدد الجلسات فقط، بل على الالتزام بالنوم، التغذية، والحضور المنتظم.",
  },
  {
    question: "هل توفرون برامج خسارة وزن مع متابعة غذائية؟",
    answer:
      "نعم، برامج خسارة الدهون لدينا تشمل توجيهاً عملياً للعادات الغذائية، متابعة الالتزام الأسبوعي، وقياسات تقدم دورية حتى لا يكون التدريب منفصلاً عن نمط حياتك اليومي.",
  },
  {
    question: "هل يمكن حجز جلسة تجريبية قبل الاشتراك؟",
    answer:
      "يمكن ترتيب زيارة أولى أو جلسة تقييم مبدئية للتعرف على المساحة، مناقشة الهدف، ومعرفة الباقة الأنسب قبل بدء البرنامج الكامل.",
  },
  {
    question: "ما الفرق بين التدريب الشخصي وEMS في NOX؟",
    answer:
      "التدريب الشخصي يعتمد على جلسات كاملة بتدرج في القوة والحركة والأداء، بينما EMS خيار أقصر زمنياً يركز على التحفيز العضلي بكفاءة عالية لأصحاب الجداول المزدحمة.",
  },
  {
    question: "هل أحتاج مستوى لياقة معين قبل أن أبدأ؟",
    answer:
      "لا. المطلوب فقط أن تبدأ من واقعك الحالي بوضوح. المدرب يضبط شدة التمرين والحمل التدريبي بما يناسب حالتك حتى تكون البداية آمنة وقابلة للاستمرار.",
  },
  {
    question: "ما أوقات العمل وهل النادي مفتوح طوال الأسبوع في عُمان؟",
    answer:
      "نعمل عادة من السبت إلى الخميس خلال ساعات تشغيل طويلة تناسب الجداول المختلفة. عند التواصل معنا نؤكد لك الأوقات المتاحة الحالية ونرتب الموعد الأنسب.",
  },
  {
    question: "هل البرامج تناسب من لديه إصابة سابقة أو عودة بعد انقطاع؟",
    answer:
      "نعم، لكن بعد تقييم أولي دقيق. إذا كانت لديك إصابة سابقة أو انقطاع طويل نعدل التمارين، نرفع الشدة تدريجياً، ونبني الخطة حول الحركة الآمنة والاستعادة الذكية.",
  },
  {
    question: "كيف أختار الباقة المناسبة لهدفي ووقتي؟",
    answer:
      "نحدد ذلك بعد معرفة هدفك الحالي، عدد الأيام المتاحة، وسرعة النتيجة التي تبحث عنها. بعدها نوصيك بمسار واضح بدلاً من تركك أمام خيارات كثيرة غير عملية.",
  },
];
